...
// @Description Mendaftarkan user baru dengan username, password, dan role.
// @Tags Auth
// @Accept json
// @Produce json
// @Param request body model.UserLogin true "User registration data (username, password, role)"
